  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          //"linear-gradient(90deg, rgba(31,30,48,1) 0%, rgba(66,66,88,1) 26%, rgba(99,132,139,1) 100%)",
          "linear-gradient(90deg, rgba(135,62,95,1) 0%, rgba(184,27,120,1) 42%, rgba(99,132,139,1) 94%",
      }}
    >
