  ...
  return (
    <div>
      ...
      <button className="p-[3px] relative">
        ...
        <div className="inline-flex h-full w-full cursor-pointer bg-slate-950 rounded-full  relative group transition duration-200 text-white hover:bg-transparent px-5 py-2 text-2xl font-bold">
          {order}
        </div>
      </button>
    </div>
